...
insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 1, 1,'01-APR-2019','03-APR-2019', 70.50);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 2, 1, '14-AGO-2019','17-AGO-2019', 135.20);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 3, 2, '30-SET-2019', '01-OTT-2019', 99.10);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 4, 3, '05-SET-2019', '07-SET-2019', 81.68);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 5, 1, '12-OTT-2019','21-OTT-2019', 60.00);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 3, 2, '01-APR-2019','04-APR-2019', 70.50);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 1, 4, '01-MAR-2019', '06-MAR-2019', 70.50);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 2, 1, '02-MAR-2019','10-MAR-2019', 70.50);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 3, 2, '01-MAR-2019', '05-MAR-2019', 70.50);

insert into BLUE_BOOKINGS(BOOKING_ID, CLIENT_ID, HOTEL_ID, CHECK_IN, CHECK_OUT, PRICE_ROOM)
values (BLUE_BOOKING_SEQ.NEXTVAL, 4, 3, '01-MAR-2019','03-MAR-2019', 70.50);

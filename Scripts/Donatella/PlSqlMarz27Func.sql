...
/
--procedura senza tabelle:
--find_max(a in,b in,max out)
--ex:find _max (3,12,max)-> max=12;
...
--function circle_area(p_radius numeric) -> circle
...
/
 ...
 --low, hight: interval coders id to increase salary
...
/
 ...
 call increase_salary_for_coders(106);

...
declare
    type t_cursor is ref cursor; -- è un cursore generico, senza specificare di che tipo
    v_cursor t_cursor;
    v_cod coders%rowtype; --sarà relativo alla tabella, all'oggetto
       
begin
    open v_cursor for  --specifico la query da eseguire
    select * 
    from coders 
    where coder_id 
    between 103 and 105;

...
import mariangela.jdbcSpring.Region;
...
public class Oved210Controller {
	...
	public String loginByGet( //
		...
		return "mariangela/welcome";
	}

	// @PostMapping("/mariangela/login")
...
//	}
	...
	public String login( //
		...
		return "mariangela/reject";

	}
	
	
	@GetMapping("/mariangela/simple")

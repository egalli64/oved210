...
public class PersonUser {
	...
	public static void main(String[] args) {
		...
		// procedimento per ottenere da un intervallo le persone ( in questo caso) con una certa caratteristica da noi richiesta.
		// faccio prima il FOR e poi l'IF nel quale con il GET vado a pescare le persone con quella caratteristica
		...
		System.out.println("***");
		// in questo caso effettuo la ricerca per altezza > di 1.70, il for riamen identico e cambia solo l'if
		for (int i = 0; i < NR_PERSONS; i++) {
		...
		for( Person person : persons) { // for each, si chiede di luppare su tutti gli elementi dell'array senza specificare nella scrittura
		...
		// mi si richiede di trovare tra tutte le persone quelle con altezza > 1.70 e quelle con età > 45
